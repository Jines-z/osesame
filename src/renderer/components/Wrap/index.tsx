...
const Wrap: FC<Props> = ({ left, right, showAdd = true, showAddTip, add }) => {
    ...
    return (
        <div className='Wrap w100p h100p relative clearfix'>
            ...
            <div className='w100p h45 absolute left-0 bottom-0 bt df justify-between bgc-white'>
                <div className='left h100p df items-center pl-18'>
                    {showAdd &&
                        <div className='h100p df items-center cur-p' onClick={onClick}>
